...
- After [installing NGINX Management Suite](#install-nms-modules), follow the steps to [Configure Vault for Storing Secrets]({{< relref "admin-guides/getting-started/configure-vault.md" >}}).
