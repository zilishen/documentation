...
To set up automatic reporting, [add your JWT-based license to NGINX Management Suite]({{< relref "/nim/admin-guide/license/add-license.md#apply-jwt-license" >}}). This license can be downloaded from [MyF5](https://account.f5.com/myf5) if needed.
{{</call-out>}}
