...
For more details on SSL/TLS termination, see the [NGINX Plus Admin Guide]({{< relref "/admin-guide/security-controls/terminating-ssl-http" >}}).
...
For configuration instructions for on‑premises deployments of NGINX Plus, see the [NGINX Plus Admin Guide]({{< relref "/admin-guide/high-availability/" >}}).
