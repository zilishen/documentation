...
description: Deploy global server load balancing (GSLB) for domains hosted in multiple AWS regions, with Amazon Route 53 and NGINX Plus in an HA configuration.
weight: 300
doctypes: ["task"]
toc: true
docs: "DOCS-448"
