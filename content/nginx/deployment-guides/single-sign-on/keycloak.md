...
* A running Keycloak server. See the Keycloak documentation for [installation](https://www.keycloak.org/docs/latest/server_installation/index.html) and [configuration](https://www.keycloak.org/docs/latest/server_admin/index.html) instructions.
