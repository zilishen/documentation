...
[New configuration setting added for never logging requests from a specified IP address range]({{< relref "/configuration-guide/configuration.md#deny-allow-and-never-log-lists" >}})
