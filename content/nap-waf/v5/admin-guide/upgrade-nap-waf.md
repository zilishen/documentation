...
For details on matching NGINX App Protect WAF releases with their WAF compiler versions, refer to the the [WAF Compiler and Supported App Protect Versions]({{< relref "/nim/app-protect/setup-waf-config-management.md#install-the-waf-compiler" >}}) topic.
