...
- security
- analytics
date: "2022-03-01T11:32:41-06:00"
...
We recommend you [upgrade the NGINX Controller Agent]({{< relref "/admin-guides/install/install-nginx-controller-agent.md#update-the-nginx-controller-agent" >}}) whenever you upgrade NGINX Controller App Delivery Module.
