...
To create an instance group using the web interface, see [Create an Instance Group]({{< relref "infrastructure/instances/manage-instances.md#create-an-instance-group" >}}).
