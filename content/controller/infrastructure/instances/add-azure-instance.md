...
To create an Integration for Azure using the [NGINX Controller API]({{< relref "api/_index.md" >}}), send a POST request similar to the following example to the Integrations API endpoint.
...
To create a Location using the [NGINX Controller API]({{< relref "api/_index.md" >}}), send a POST request similar to the following example to the Locations API endpoint.
...
For the Instance Template, you can provide the details for an NGINX image on the Azure Marketplace, or you can provide the image and network details for your own instance. Refer to the [NGINX Controller Technical Specifications]({{< relref "admin-guides/install/nginx-controller-tech-specs.md" >}}) guide for the NGINX Plus requirements.

- To create an Instance Template for an Azure Marketplace image using the [NGINX Controller REST API]({{< relref "api/_index.md" >}}), send a POST request similar to the following example to the Instance Templates API endpoint. You can find descriptions of the instance parameters in the API Reference documentation.
...
- To create an Azure Instance Template for your own instance using the [NGINX Controller REST API]({{< relref "api/_index.md" >}}, send a POST request similar to the following example to the Instance Templates API endpoint.
...
To add an Azure NGINX instance to NGINX Controller using the [NGINX Controller REST API]({{< relref "api/_index.md" >}}), send a POST request similar to the following example to the Instances API endpoint. For the `templateRef` parameter, use the Instance Template that you created in the previous procedure.
