...
You can include NGINX Controller Caching data when creating [custom dashboards]({{< ref "analytics/dashboards/custom-dashboards" >}}) and [alerts]({{< ref "analytics/alerts/manage-alerts" >}}) for your applications.
