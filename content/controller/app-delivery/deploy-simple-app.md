...
- [About Environments]({{< relref "services/manage-environments.md#about-environments" >}})
...
- [About Certificates]({{< relref "services/manage-certs.md#about-certificates" >}})
- [Create a certificate]({{< relref "services/manage-certs.md#create-a-cert" >}})

## Create a Gateway

Next, you'll need to create a Gateway. Be sure to add the Gateway to your Environment.

- [About Gateways]({{< relref "services/manage-gateways.md#about-gateways" >}})
...
- [About Apps]({{< relref "/app-delivery/about-app-delivery.md#apps" >}})
- [Create an App]({{< relref "/app-delivery/manage-apps.md#create-an-app" >}})
...
- [About Components]({{< relref "/app-delivery/about-app-delivery.md#components" >}})
- [Create a Component]({{< relref "/app-delivery/manage-apps.md#create-a-component" >}})
