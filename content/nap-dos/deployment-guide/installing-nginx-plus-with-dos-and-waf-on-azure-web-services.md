...
description: Install NGINX Plus, NGINX App Protect WAF + DoS on Microsoft Azure, to provide sophisticated Layer 7 load balancing, Modern app security solution,
...
- admin
- user
title: NGINX App Protect WAF + DoS AMIs on Microsoft Azure
toc: true
versions:
- "4.2"
weight: 110
