...
This topic lists the default values that are used when [installing the Developer Portal from a Helm chart]({{< relref "installation/kubernetes/nms-helm.md" >}}). You can change these values to meet your specific needs.
