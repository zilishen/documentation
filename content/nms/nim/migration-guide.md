...
{{< see-also >}}
To perform a clean installation of NGINX Management Suite (NMS) and Instance Manager, refer to the [NMS installation guide]({{< relref "/admin-guides/installation/on-prem/install-guide.md" >}}).
{{< /see-also>}}
...
1. Follow the instructions for [Installing Instance Manager]({{< ref "/admin-guides/installation/on-prem/install-guide.md" >}}). License Instance Manager according to the installation guide.
