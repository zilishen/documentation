...
| v1.customExtensions | User defined objects specified in top level customExtensions object in the API request. |
...
| mergedCustomExtensions | The result of merging URI-level with Gateway-level customExtensions objects.<br>In case there is a duplicate key present in both objects, the URI-level value will be used.                                                                                   |     
...
| mergedCustomExtensions | The result of merging URI-level with TCPUDP-Component-level customExtensions objects.<br>In case there is a duplicate key present in both objects, the URI-level value will be used.                                                                                |  
...
| customExtensions        | User defined objects specified by the customExtensions object under the URI in the API request. |
| mergedCustomExtensions | The result of merging URI-level with Web-Component-level customExtensions objects. <br>In case there is a duplicate key present in both objects, the URI-level value will be used.                                                                             |  
