...
See the [Upgrade Guide]({{< relref "/nms/installation/upgrade-guide.md#upgrade-instance-manager" >}}) for instructions on upgrading Instance Manger from a Helm chart.
