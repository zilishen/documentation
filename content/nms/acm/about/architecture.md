...
| Data Plane                          | [NGINX Plus](https://www.nginx.com/products/nginx/) instances in the traffic path that act as load balancers, API gateways, firewalls, ingress controllers, and caching systems read and manage inbound and outbound packets.                                                            |
