...
1. Follow the steps in the [Installation Guide]({{< relref "/nms/admin-guides/installation/on-prem/install-guide" >}}) to set up NGINX Management Suite and ACM. You do not need to configure a Developer Portal for this tutorial.
