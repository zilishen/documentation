...
1. [Install API Connectivity Manager and Developer Portal]({{< relref "/nms/admin-guides/installation/on-prem/install-guide.md" >}}) on [separate hosts]({{< relref "tech-specs.md" >}}).
